...
const preferredNavOrder = ['灵感地图', '精选攻略', '个性化出行', '限时特惠']
    ...
    <footer class="site-footer" v-if="!isAdmin">
      <div class="footer-inner">
        <div class="footer-col">
          <h5>服务保障</h5>
          <p>7x24 智能客服 · 行前提醒 · 风险提示</p>
        </div>
        <div class="footer-col">
          <h5>企业合作</h5>
          <p><a href="/enterprise">商旅管理平台 / API 接入 / SaaS 定制方案</a></p>
        </div>
        <div class="footer-col">
          <h5>联系我们</h5>
          <p>
            <a href="mailto:service@travelflow.com">service@travelflow.com</a>
            ·
            <a href="tel:4008882026">400-888-2026</a>
          </p>
        </div>
      </div>
      <p class="copyright">© 2026 TravelFlow 旅迹科技 · All Rights Reserved</p>
    </footer>
    ...
    <div v-if="showAuthModal" class="auth-mask" @click.self="closeAuth">
      <div class="auth-modal">
        ...
        <template v-else>
          ...
          <label>
            邮箱（可选）
            <input v-model="registerEmail" placeholder="name@example.com" @input="clearAuthError" />
          </label>
          <label>
            密码
